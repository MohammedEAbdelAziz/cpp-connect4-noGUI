// includes class definition for the original game (provided by dr el-ramly) and the new game (four in a row)
#include <string>
#ifndef _Connect4_CLASSES_H
#define _Connect4_CLASSES_H
using namespace std;
...
class FourInRowBoard : public Board {
public:
  FourInRowBoard();
...
// that generates random positions x y (0 to 4)
...
public:
  GameManager(Board *, Player *playerPtr[4]);
  void run();
  // Added for connect 4 game
  void runfour();
